 ...
 */
public class NavServiceFAQFragment extends FragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context = getContext();
        FAQRecyclerAdapter mAdapter = new FAQRecyclerAdapter(getContext(),nums[0]);
