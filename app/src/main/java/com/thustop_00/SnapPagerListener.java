...
public class SnapPagerListener extends RecyclerView.OnScrollListener {
    ...
    public SnapPagerListener(PagerSnapHelper snapHelper, @Type int type, boolean notifyOnInit, OnChangeListener listener) {
